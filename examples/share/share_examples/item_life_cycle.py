...
def main():
    try:
        ...
        # Download file
        print("\nDownloading file...")
        share.download_file(url=resp_get_archive.result.dest_url)
        share.download_file(url=resp_get_archive.result.dest_url, filename="download.tar")
        share.download_file(url=resp_get_archive.result.dest_url, dest_folder="./download/")
        share.download_file(

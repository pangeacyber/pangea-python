...
class Db:
    ...
    def add_employee(self, emp: Employee) -> bool:
        ...
        data = (emp.first_name, emp.last_name, emp.personal_email, emp.phone, emp.date_of_birth, emp.ssn, int(emp.status))

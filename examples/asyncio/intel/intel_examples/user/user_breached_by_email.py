...
#
# Determine if an email address was exposed in a security breach.
...
async def main():
    ...
    try:
        response = await intel.user_breached(email="test@example.com", provider="spycloud", verbose=True, raw=True)

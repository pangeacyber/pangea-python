...
pnpm dlx start-server-and-test --expect 404 \
  ...
  4010 \
  "poetry run pytest tests/integration2/test_ip_intel.py"
...
pnpm dlx start-server-and-test --expect 404 \
  ...
  4010 \
  "uv run pytest tests/integration2/test_vault.py"

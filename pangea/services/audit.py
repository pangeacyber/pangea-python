...
class Audit(ServiceBase):
    ...
    Provides methods to interact with Pangea Audit Service:
        [https://docs.dev.aws.pangea.cloud/docs/api/log-an-entry](https://docs.dev.aws.pangea.cloud/docs/api/log-an-entry)
    ...
    def log(self, event: dict, verify: bool = False, signing: bool = False, verbose: bool = False) -> PangeaResponse:
        ...
        Returns:
            A PangeaResponse where the hash of event data and optional verbose
                ...
                [https://docs.dev.aws.pangea.cloud/docs/api/audit#log-an-entry](https://docs.dev.aws.pangea.cloud/docs/api/audit#log-an-entry)
    ...
    def search(
        ...
        Returns:
            A PangeaResponse where the first page of matched events is returned in the
                ...
                [https://docs.dev.aws.pangea.cloud/docs/api/audit#search-for-events](https://docs.dev.aws.pangea.cloud/docs/api/audit#search-for-events)
                Pagination can be found at:
                [https://docs.dev.aws.pangea.cloud/docs/api/audit#search-results](https://docs.dev.aws.pangea.cloud/docs/api/audit#search-results)
    ...
    def can_verify_membership_proof(self, event: JSONObject) -> bool:
        ...
        Read more at: [What is a membership proof?](https://docs.dev.aws.pangea.cloud/docs/audit/tamperproof/tamperproof-audit-logs#what-is-a-membership-proof)
    ...
    def can_verify_consistency_proof(self, event: JSONObject) -> bool:
        ...
        Read more at: [Cryptographic Signatures](https://docs.dev.aws.pangea.cloud/docs/audit/tamperproof/tamperproof-audit-logs#cryptographic-signatures)
